...
=======
        <div className="p-6 bg-white shadow-lg rounded-md mt-10">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <button onClick={() => { navigate('/lead') }} className="mb-4 px-4 py-2 bg-green-600 text-white rounded">Go To Lead Dashboard</button>
            </div>
            <div className="overflow-x-auto">
                <table className="min-w-full text-sm text-left text-gray-700">
                    <thead className="text-xs text-white uppercase bg-blue-600">
                    ...
                    <tbody>
                        {currentUsers.map((user, idx) => (
                            <tr key={idx} className="bg-white border-b hover:bg-gray-50">
                                ...
                                {/* <td className="px-6 py-4">
                                    <button onClick={() => handleViewLeads(user)} className="text-blue-600 hover:underline">View Leads</button>
                                </td> */}
                                {/* <td className="px-6 py-4">{lead.medicalNeeds}</td>
                                <td className="px-6 py-4">
                                    <button onClick={() => handleEditClick(lead)} className="text-blue-600 hover:underline">Edit</button>
